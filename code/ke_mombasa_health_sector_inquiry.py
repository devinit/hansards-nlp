...
if __name__ == '__main__':
    system_prompt = (
        ...
        "to extract attributes of a transcript as JSON. "
    ...
    functions = [
        {
            ...
            "description": "Extract the attributes of a transcript.",
            "parameters": {
                "type": "object",
                    "properties": {
                        "transcript_date": {
                            "type": "string",
                            "description": "What is the date at the top of the transcript?"
                        },
                        "health_discussed": {
                            "type": "string",
                            "description": "Was health discussed at any point during this transcript? Yes or No."
                        },
                        "health_discussed_people_names": {
                            "type": "string",
                            "description": "The names of the people that participated in discussions about health during the transcript. Just their names, comma separated."
                        },
                        ...
                        "health_sector_decisions": {
                            "type": "string",
                            "description": "What decisions or resolutions or policies or laws were made regarding financing the health sector, if any?"
                        },
                        "health_evidence_base": {
                            "type": "string",
                            "description": "What evidence was used to inform any decisions or recommendations or resolutions or policies or laws?"
                        },
                        "health_evidence_requested": {
                            "type": "string",
                            "description": "What health information was requested or demanded, and who was it requested from?"
                        },
                    },
                "required": [
                    "transcript_date",
    ...
    all_files = glob("mombasa_texts/*.txt")
    ...
    if warn_user_about_tokens(tokenizer, all_file_full_text_list, other_prompts=json.dumps(functions)) == True:
        ...
        for txt_filename in tqdm(all_files):
            ...
            for batch_i, batch in enumerate(batches):
                json_outfile = os.path.join("ke_mombasa_health_json_responses", "{}_{}.json".format(txt_file_basename, batch_i))
